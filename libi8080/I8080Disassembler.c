...
const char* const I8080InstrDisassemblyFormat[256] = {
    ...
    PREFIX_1BYTE "INR L" RESULT_L " " STATE_F "\n",
    PREFIX_1BYTE "DCR L" RESULT_L " " STATE_F "\n",
    PREFIX_2BYTE "MVI L, " OPERAND_IMMED8 RESULT_L "\n",
    PREFIX_1BYTE "CMA" RESULT_A "\n",
    PREFIX_1BYTE "NOP\n",
    PREFIX_3BYTE "LXI SP, " OPERAND_IMMED16 RESULT_SP "\n",
    PREFIX_3BYTE "STA " OPERAND_ADDR RESULT_A "\n",
    PREFIX_1BYTE "INX SP" RESULT_SP "\n",
    PREFIX_1BYTE "INR M (" VALUE_HL ")" RESULT_IND_M " " STATE_F "\n",
    PREFIX_1BYTE "DCR M (" VALUE_HL ")" RESULT_IND_M " " STATE_F "\n",
    PREFIX_1BYTE "MVI M (" VALUE_HL "), " OPERAND_IMMED8 RESULT_IND_M "\n",
    PREFIX_1BYTE "STC" RESULT_F "\n",
    PREFIX_1BYTE "NOP\n",
    PREFIX_1BYTE "DAD SP" RESULT_HL "\n",
    PREFIX_3BYTE "LDA " OPERAND_ADDR RESULT_A "\n",
    PREFIX_1BYTE "DCX SP" RESULT_SP "\n",
    PREFIX_1BYTE "INR A" RESULT_A " " STATE_F "\n",
    PREFIX_1BYTE "DCR A" RESULT_A " " STATE_F "\n",
    ...
    PREFIX_1BYTE "ADD M (" VALUE_HL "=" VALUE_IND_M ")" RESULT_A " " STATE_F "\n",
    ...
    PREFIX_1BYTE "ADC M (" VALUE_HL "=" VALUE_IND_M ")" RESULT_A " " STATE_F "\n",
    ...
    PREFIX_1BYTE "SUB M (" VALUE_HL "=" VALUE_IND_M ")" RESULT_A " " STATE_F "\n",
    ...
    PREFIX_1BYTE "SBB M (" VALUE_HL "=" VALUE_IND_M ")" RESULT_A " " STATE_F "\n",
    ...
    PREFIX_1BYTE "ANA M (" VALUE_HL "=" VALUE_IND_M ")" RESULT_A " " STATE_F "\n",
    ...
    PREFIX_1BYTE "XRA M (" VALUE_HL "=" VALUE_IND_M ")" RESULT_A " " STATE_F "\n",
    ...
    PREFIX_1BYTE "ORA M (" VALUE_HL "=" VALUE_IND_M ")" RESULT_A " " STATE_F "\n",
